...
async def group_classification_results_activity(
    ...
    for page_data in pages:
        ...
        # Look for common indicators of surgery schedule
        ...
        # Try to find first name, last name, and DOB in the classification data
        first_name = None
        last_name = None
        dob = None
        ...
        # If we found patient information, normalize and group
